...
describe('Login Test for Jubelio', () => {
  it('should successfully log in with valid credentials', () => {
    ...
    // Inventory
    cy.visit('https://v2.jubelio.com/inventory')

    // Stock Transaction
    cy.visit('https://v2.jubelio.com/inventory/stock_transaction')
    ...
    cy.get('.MuiAutocomplete-listbox li').contains('Pusat').click()
